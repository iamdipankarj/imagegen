...
export function PromptBox({
  ...
  return  (
    <div className={cn("w-full relative bg-base-transparent group")} {...props}>
      ...
      <div className="relative bg-base-100 p-2 rounded-2xl outline-solid outline-base-content/0 group-focus-within:outline-gray-300/50">
        <textarea
          className="input px-2 text-lg! w-full border-none focus:outline-hidden min-h-[100px]"
