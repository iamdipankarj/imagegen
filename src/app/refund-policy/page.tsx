...
export const metadata: Metadata = getMetaData({
  title: "Refund Policy | imagegen",
  description: "Refund Policy for imagegen."
});
    ...
    <section id="refund">
      ...
      <div className="container mx-auto px-4 py-6 prose">
        ...
        <ul>
          ...
          <li>
            <p>By visiting this page on our website: <a href="https://imagegen/refund-policy" rel="external nofollow noopener" target="_blank">https://imagegen/refund-policy</a>
            </p>
          </li>
        </ul>
      </div>
