  ...
  return (
    <section id="refund">
      ...
      <div className="container mx-auto px-4 py-6 prose">
        ...
        <p>Due to the high costs involved in powering the advanced GPUs for our AI art generation, we unfortunately cannot offer refunds once credits have been used. We realize this may not be the ideal scenario for everyone, but this policy helps us to maintain a fair and sustainable service for all of our valued users.</p>
